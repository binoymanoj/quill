        ...
        <div className="relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[35.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]"
            />
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto my-32 max-w-5xl sm:mt-56">
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:p-0 md:pl-0 md:pt-4">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:p-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                We&apos;ll provide your file and make it ready for you to chat
                with.
              </span>
            </div>
          </li>
